...
#ifndef INCLUDE_CNF2GRAPH_LITERAL_H_
#define INCLUDE_CNF2GRAPH_LITERAL_H_

#include <string>

#include "cnf2graph/Logging.h"
#include "cnf2graph/IntType.h"
...
namespace std {
template <>
struct hash<cnf2graph::Literal> {
    size_t operator()(const cnf2graph::Literal& literal) const {
        return literal.index().value();
    }
};
}  // namespace std

#endif  // INCLUDE_CNF2GRAPH_LITERAL_H_
